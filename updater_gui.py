...
class UpdaterWindow(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle("KazLauncher Updater")
    ...
    def start_download(self):
        ...
        self.new_launcher_temp_path = os.path.join(temp_dir, "KazLauncher_new.exe")
    ...
    def install_and_restart(self, new_downloaded_path):
        ...
        finalizer_bat_path = os.path.join(temp_dir, "kazlauncher_finalizer.bat")
